...
export function Navbar({ burgerMenu, setBurgerMenu }) {
  return (<>
    <nav className='w-full fixed top-0 z-20 h-20 transition-all shadow-lg flex bg-white items-center r justify-between lg:justify-evenly'>
      ...
      <div className='hidden h-7 lg:w-[40%] lg:block'>
